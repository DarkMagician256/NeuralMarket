...
export const markets: Market[] = [
    { id: 'm1', ticker: 'BTC-100K', title: 'Bitcoin > $100k by 2026?', category: 'CRYPTO', probability: 42, volume: '$12.5M', cortexSignal: 'BULLISH', change24h: 5.2 },
    { id: 'm2', ticker: 'TRUMP-2028', title: 'Donald Trump wins 2028 Election?', category: 'POLITICS', probability: 31, volume: '$45.2M', change24h: -1.2 },
    { id: 'm3', ticker: 'FED-RATE-CUT', title: 'Fed cuts rates in March?', category: 'ECONOMY', probability: 85, volume: '$8.1M', cortexSignal: 'BEARISH', change24h: 0.5 },
    { id: 'm4', ticker: 'AGI-2025', title: 'AGI achieved by Q4 2025?', category: 'SCIENCE', probability: 12, volume: '$3.4M', change24h: 2.1 },
    { id: 'm5', ticker: 'GTA6-DELAY', title: 'GTA VI delayed to 2027?', category: 'CULTURE', probability: 25, volume: '$1.2M', change24h: -0.5 },
    { id: 'm6', ticker: 'SOL-FLIP-ETH', title: 'Solana flips Ethereum Market Cap?', category: 'CRYPTO', probability: 18, volume: '$9.8M', cortexSignal: 'BULLISH', change24h: 8.4 },
    { id: 'm7', ticker: 'MARS-LANDING', title: 'Humans land on Mars before 2030?', category: 'SCIENCE', probability: 8, volume: '$500k', change24h: 0.0 },
    { id: 'm8', ticker: 'RECESSION-2026', title: 'US Recession declared in 2026?', category: 'ECONOMY', probability: 45, volume: '$15.2M', change24h: 3.2 },
    ...
    { id: 'm10', ticker: 'ETH-ETF-STAKE', title: 'ETH ETF enables staking?', category: 'CRYPTO', probability: 67, volume: '$2.1M', change24h: 1.1 },
    { id: 'm11', ticker: 'CHINA-TAIWAN', title: 'Conflict in Taiwan Strait?', category: 'POLITICS', probability: 15, volume: '$22.1M', change24h: 0.2 },
    ...
    { id: 'm13', ticker: 'OIL-100', title: 'Crude Oil > $100/barrel?', category: 'ECONOMY', probability: 38, volume: '$6.7M', cortexSignal: 'BULLISH', change24h: 4.5 },
    { id: 'm14', ticker: 'OSCARS-BOP', title: 'Barbenheimer wins Best Picture?', category: 'CULTURE', probability: 55, volume: '$1.8M', change24h: -2.3 },
    ...
    { id: 'm16', ticker: 'UK-ELECTION', title: 'Labour wins UK General Election?', category: 'POLITICS', probability: 92, volume: '$11.2M', change24h: 0.1 },
    ...
    { id: 'm18', ticker: 'NFL-SUPERBOWL', title: 'Chiefs win Super Bowl LIX?', category: 'CULTURE', probability: 28, volume: '$25.4M', change24h: 5.5 },
    ...
    { id: 'm20', ticker: 'LINK-ATH', title: 'Chainlink breaks ATH in 2026?', category: 'CRYPTO', probability: 52, volume: '$3.9M', cortexSignal: 'BULLISH', change24h: 12.1 },
];

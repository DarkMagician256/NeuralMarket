...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    leaderboard_subtitle: "Top-performing autonomous agents on the neural network. Ranked by ELO Rating and validated via 3-Tier Cognitive Consensus (DeepSeek → Claude → OpenAI).",

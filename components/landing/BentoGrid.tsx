...
import { Building2, BrainCircuit, Zap, Users, ShieldCheck, LineChart, Globe } from 'lucide-react';
        ...
        <section className="container mx-auto px-4 py-20 md:py-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 auto-rows-[250px] md:auto-rows-[300px]">
                ...
                <motion.div
                    ...
                    className="md:col-span-2 glass-panel p-8 relative overflow-hidden group flex flex-col justify-end"
                >
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-xs font-mono text-purple-300">CORE ENGINE</span>
                        </div>
                        <h3 className="text-3xl md:text-4xl font-bold mb-3 text-white group-hover:text-purple-300 transition-colors">Neural Swarm Intelligence</h3>
                        <p className="text-gray-400 max-w-lg text-sm md:text-base leading-relaxed">
                            A decentralized network of specialized AI agents (Sniper, Whale Watcher, Macro Analyst) that form a consensus swarm to predict market outcomes with higher accuracy than individual models.
                        </p>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="md:row-span-2 glass-panel p-8 relative overflow-hidden group flex flex-col"
                >
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                        <div className="p-3 bg-green-500/20 rounded-xl w-fit mb-6 border border-green-500/30">
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="text-2xl font-bold mb-2">Kalshi Integration</h3>
                        <p className="text-gray-400 text-sm">
                            Direct feed from Kalshi, the first CFTC-regulated exchange for event contracts. Trade on Fed rates, elections, and more.
                        </p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="text-2xl font-bold mb-2">Deep Liquidity</h3>
                        <p className="text-gray-400 text-sm">
                            Aggregated liquidity via DFlow ensures minimal slippage for large volume trades executed by agent swarms.
                        </p>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="md:col-span-2 glass-panel p-8 relative overflow-hidden group flex items-center opacity-70 hover:opacity-100 transition-opacity"
                >
                    ...
                    <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            <div className="flex items-center gap-3 mb-4">
                                <div className="p-3 bg-white/5 rounded-xl border border-white/10 grayscale">
                                    <ShieldCheck className="text-gray-400" size={28} />
                                </div>
                                <span className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-mono text-gray-400">COMING SOON</span>
                            </div>
                            <h3 className="text-2xl font-bold mb-2 text-gray-300">Community Governance</h3>
                            <p className="text-gray-500 text-sm mb-6">
                                The Neural Council will vote on new market listings and protocol parameters. Governance token launch pending.
                            </p>

...
var KALSHI_MCP_URL = "https://kalshi-mcp-server-production.up.railway.app";
function makeRequest(method, path2, body, headers) {
  return new Promise((resolve, reject) => {
    const url = new URL(path2, KALSHI_MCP_URL);
    const options = {
...
async function mcpCall(toolName, args = {}, apiKey) {
  const headers = {};
...
function encryptWalletForImport(privateKeyBase58, password) {
  if (password.length < 12) {
    throw new Error("Password must be at least 12 characters");
  }
  const salt = crypto.randomBytes(32);
  const derivedKey = crypto.pbkdf2Sync(password, salt, 1e5, 32, "sha512");
...
program.name("quantish-kalshi").description("Quantish Kalshi SDK CLI - Prediction market trading on Solana").version("1.0.0");
program.command("setup").description("Interactive setup wizard for Quantish Kalshi SDK").action(async () => {
  console.log("\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557");
  ...
  try {
    ...
    if (walletChoice.toLowerCase() === "import") {
      ...
      if (walletContent.wallet) {
        ...
        console.log("\n\u{1F4B0} Fund this address with SOL and USDC to start trading");
      } else {
...
program.command("import-wallet").description("Securely import an existing Solana wallet").option("-k, --api-key <key>", "Your Quantish Kalshi API key").action(async (options) => {
  console.log("\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557");
  ...
  try {
    ...
    console.log("\n\u{1F4DD} Enter your Solana private key (Base58 format):");
    ...
    console.log("\n\u{1F510} Create a strong password (min 12 characters):");
...
program.command("config").description("Generate MCP configuration for Cursor IDE").option("-k, --api-key <key>", "Your Quantish Kalshi API key").action(async (options) => {
  console.log("\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557");
  ...
  if (!apiKey) {
    ...
    apiKey = await new Promise(
      (resolve) => rl.question("Enter your API key (pk_kalshi_...): ", resolve)
    );
    rl.close();
  }
  if (!apiKey.startsWith("pk_kalshi_")) {
  ...
  console.log("\n\u{1F4CB} CURSOR IDE CONFIGURATION");
  console.log("\u2550".repeat(50));
  ...
  console.log("\n\u{1F4CB} CLAUDE DESKTOP CONFIGURATION");
  console.log("\u2550".repeat(50));
...
program.command("enable").description("Automatically add Kalshi SDK to Cursor MCP config").option("-k, --api-key <key>", "Your Quantish Kalshi API key").action(async (options) => {
  console.log("\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557");
...
program.command("test").description("Test your Kalshi SDK connection and wallet").option("-k, --api-key <key>", "Your Quantish Kalshi API key").action(async (options) => {
  console.log("\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557");
...
program.command("balance").description("Check your wallet balance").option("-k, --api-key <key>", "Your Quantish Kalshi API key").action(async (options) => {
  let apiKey = options.apiKey;
  if (!apiKey) {
    const rl = readline.createInterface({
      input: process.stdin,
    ...
    apiKey = await new Promise(
      (resolve) => rl.question("Enter your API key: ", resolve)
    );
    rl.close();
  }
  try {

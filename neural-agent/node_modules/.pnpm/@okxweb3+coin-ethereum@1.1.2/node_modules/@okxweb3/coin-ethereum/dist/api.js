...
const eth_sig_util_3 = require("@metamask/eth-sig-util");
function getNewAddress(privateKeyHex) {
    ...
    const publicKey = (0, sdk_1.privateToPublicRaw)(privateKey);
    const address = (0, sdk_1.publicToAddress)(publicKey.slice(1));
    return {
...
function signMessage(messageType, message, privateKey) {
    ...
    if (messageType == message_1.MessageTypes.TYPE_DATA_V1) {
        return (0, eth_sig_util_3.signTypedData)({ privateKey: privateKey, data: JSON.parse(message), version: eth_sig_util_1.SignTypedDataVersion.V1 });
    }
    else if (messageType == message_1.MessageTypes.TYPE_DATA_V3) {
        return (0, eth_sig_util_3.signTypedData)({ privateKey: privateKey, data: JSON.parse(message), version: eth_sig_util_1.SignTypedDataVersion.V3 });
    }
    else if (messageType == message_1.MessageTypes.TYPE_DATA_V4) {
        return (0, eth_sig_util_3.signTypedData)({ privateKey: privateKey, data: JSON.parse(message), version: eth_sig_util_1.SignTypedDataVersion.V4 });
    }

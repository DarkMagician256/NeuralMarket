...
class DexAPI {
    ...
    async getSolanaSwapInstruction(params) {
        ...
        return this.client.request("GET", "/api/v5/dex/aggregator/swap-instruction", this.toAPIParams(params));
    }
    async executeSolanaSwapInstructions(params) {
        var _a;
        const instructionResp = await this.getSolanaSwapInstruction(params);
        const respAny = instructionResp;
        const instructionData = Array.isArray(respAny === null || respAny === void 0 ? void 0 : respAny.data) ? respAny.data[0] : respAny === null || respAny === void 0 ? void 0 : respAny.data;
        if (!instructionData) {
